...
Link: https://leetcode.com/problems/sales-person/description/?envType=study-plan&id=sql-i
*/
...
WHERE s1.sales_id NOT IN ( 
    ...
    WHERE c.name = 'RED');
--- We use NOT IN because we are looking for sales people that have nothing to do with 'RED' company.
